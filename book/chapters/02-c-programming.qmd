...
### Integer Sizes Across Microcontrollers
...
![Stack frame layout showing how a function call stores local variables and parameters in memory](../images/ch02/ch02-swap-before.png){#fig-ch02-pointer-swap-stack-frame}
...
![The updated stack state after the swap call returns to `main`](../images/ch02/ch02-swap-after.png){#fig-ch02-pointer-swap-after-return}
