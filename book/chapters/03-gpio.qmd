...
![Power Regulation for the NUCLEO-F091RC](../images/ch03/ch03-nucleo-power-regulation.png){#fig-ch03-nucleo-power}
...
![The processory reads instructions from memory, which then read and write to the data in RAM.](../images/ch03/ch03-processor-and-memory.png){#fig-ch03-proc-mem}
...
![The GPIO bit set/reset register (GPIOx_ODR) provides atomic writes to set or reset a GPIO output pin.](../images/ch03/ch03-bsrr-register.png){#fig-ch03-bsrr}
